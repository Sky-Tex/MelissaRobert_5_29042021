	  ...
	  data.forEach((item)  => { 
		const { name, price, _id, description, imageUrl } = item;
				...
				<div class="container col-md-6 col-lg-4">
				   <div class="affichage_produit mt-4 card bg-white" onclick="window.location.href = './produit.html?id=${_id}'">
					  ...
					  <div class="card-body">
						 ...
						 <div class="text-center mt-4" ><a id="bouton" type="button" class="btn btn-secondary text-white">Choisir</a></div>
					  </div>
				   </div>
				</div>`
	   })
